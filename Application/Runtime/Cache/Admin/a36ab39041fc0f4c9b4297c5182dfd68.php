...
<legend>Qrcode实现二维码在线生成</legend>
</fieldset>
<?php if($flag == 'true'): ?><img src="/index.php/Admin/Qrcode/qrcode/data/<?php echo I('post.url');?>">
<a href="/index.php/Admin/Qrcode/qrcode_save/data/<?php echo I('post.url');?>" class="ajax-get">保存二维码到根目录Qrcode下</a><?php endif; ?>
<form class="layui-form layui-form-pane users-add-form" action="/index.php/Admin/Qrcode/index" method="post">
  <div class="layui-form-item">
    <label class="layui-form-label">url地址</label>
    <div class="layui-input-inline">
      <input name="url" required lay-verify="required" placeholder="请输入网址" autocomplete="off" class="layui-input" type="text">
    </div>
  </div>
  <div class="layui-form-item">
    <button class="layui-btn" type="submit" lay-filter="demo2">生 成</button>
    <a href="/index.php/Admin/Qrcode/index" class="layui-btn layui-btn-primary" lay-submit="" lay-filter="demo2">取 消</a>
  </div>
</form> 
