...
<div class="conright" >
  ...
  <legend>用户列表</legend>
                   ...
                   <div class="btomt">
                       <button onclick="window.location.href='/index.php/Admin/UsersInformation/add'" class="layui-btn">
                 ...
                 <!--    <div class="btomt">
                   ...
                   <form action="/index.php/Admin/UsersInformation/index" method="get">
                   关键字查询：<input name="keyword"><input type="submit" value="查询" class="layui-btn layui-btn-mini layui-btn-normal">
                   </div>
                   </form>
                 <table class="layui-table">
                      ...
                      <?php if(is_array($db)): $i = 0; $__LIST__ = $db;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$db): $mod = ($i % 2 );++$i;?><tr>
                          <td><?php echo ($db["username"]); ?></td>
                                ...
                                <td><?php echo ($db["sex"]); ?></td>
                                <td><?php echo ($db["birthday"]); ?></td>
                                <td><?php echo ($db["age"]); ?></td>
                                   <td><?php echo (date("Y-m-d H:i:s",$db["add_time"])); ?></td>
                                
                                <td>
                                <a href="/index.php/Admin/UsersInformation/edit/id/<?php echo ($db["id"]); ?>" class="layui-btn layui-btn-mini layui-btn-normal">修改</a>
                               
                                <a data-msg="是否确定彻底删除数据？" href="/index.php/Admin/UsersInformation/del_data/id/<?php echo ($db["id"]); ?>" class="ajax-get confirm layui-btn layui-btn-mini layui-btn-danger">数据删除</a>
                                </td>
