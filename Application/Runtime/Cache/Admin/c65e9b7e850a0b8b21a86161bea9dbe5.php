...
<div class="conright" >
  ...
  <legend>用户数据导入导出</legend>
</fieldset>
                <div class="bomol">
                   </div>
                   <div class="btomt">
                       <button onclick="window.location.href='/index.php/Admin/Excel/import'" class="layui-btn">
                                      <i class="layui-icon">&#xe608;</i> 导入
                       </button>
                       <button onclick="window.location.href='/index.php/Admin/Excel/export'" class="layui-btn">
