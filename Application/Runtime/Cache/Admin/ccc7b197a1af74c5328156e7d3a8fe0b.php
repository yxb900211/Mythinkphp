...
<div class="conright" >
  ...
  <legend>数据库备份</legend>
        ...
        <a id="optimize" class="layui-btn layui-btn-small layui-btn-normal" href="<?php echo U('Database/optimize');?>">优化表</a>
        <a id="repair" class="layui-btn layui-btn-small layui-btn-normal" href="<?php echo U('Database/repair');?>">修复表</a>
        <a id="repair" class="layui-btn layui-btn-small layui-btn-danger" href="<?php echo U('Database/reduction');?>">数据还原</a>
                    </div>
